...
`com.gyz.cfmall.search.service.impl.MallSearchServiceImpl#buildSearchQuest`
...
注意细节：`th:text` 会进行转义 ，`th:utext`不会进行转义，如果使用`th:text`，带keyword高亮之后，标题展示不出来

![](https://cfmall-hello.oss-cn-beijing.aliyuncs.com/img/202312/8e1f08d51375fff3b8bafe96b128f96e.png#id=PmuIq&originHeight=786&originWidth=1183&originalType=binary&ratio=1&rotation=0&showTitle=false&status=done&style=none&title=)

### 2.2 品牌显示

![](https://cfmall-hello.oss-cn-beijing.aliyuncs.com/img/202312/223b0967babb88111c32de34742b71c1.png#id=gAI7n&originHeight=586&originWidth=727&originalType=binary&ratio=1&rotation=0&showTitle=false&status=done&style=none&title=)

### 2.3 分类显示

![](https://cfmall-hello.oss-cn-beijing.aliyuncs.com/img/202312/a54ff352b22a8253ae300dca9e902c69.png#id=boeum&originHeight=842&originWidth=904&originalType=binary&ratio=1&rotation=0&showTitle=false&status=done&style=none&title=)

### 2.4 属性显示

![](https://cfmall-hello.oss-cn-beijing.aliyuncs.com/img/202312/fc8f1888555f9c96b337e03419213ec2.png#id=Q2vwI&originHeight=400&originWidth=805&originalType=binary&ratio=1&rotation=0&showTitle=false&status=done&style=none&title=)

---

## 3、测试结果

![](https://cfmall-hello.oss-cn-beijing.aliyuncs.com/img/202312/f8ee567f9fb619c7428cd39c3384f398.png#id=GIgR4&originHeight=883&originWidth=1414&originalType=binary&ratio=1&rotation=0&showTitle=false&status=done&style=none&title=)
    ...
    <div class="header_head_box">
        <b class="header_head_p">
            <div style="overflow: hidden">
                <a href="http://cfmall.com" class="header_head_p_a1" style="width:73px;">
                    谷粒商城首页
                </a>
...
<div class="header_sous">
    <div class="logo">
        <a href="http://cfmall.com"><img src="/static/search/image/logo1.jpg" alt=""></a>
    </div>
    <div class="header_form">
        <input type="text" placeholder="手机"/>
        <a href="/static/search/#">搜索</a>
    </div>
                    ...
                    <div class="sl_value">
                        <ul>
                            <li th:each="attrValue : ${attr.attrValue}">
                                <a href="/static/search/#" th:text="${attrValue}">5.56英寸及以上
                                </a>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="filter_page">
                        <div class="page_wrap">
                            <span class="page_span1">
                                ...
                                <a href="/static/search/#"
                                   style="border: 0;font-size: 20px;color: #999;background: #fff">...</a>
